...
public class Ex_RestDayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.exec_rest_day_layout);
        ...
        refreshAd();
        getSupportActionBar().setTitle((CharSequence) "Rest Day");
...
//                Toast.makeText(SakaStartActivity.this, "Failed to load native ad: "
