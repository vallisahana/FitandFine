...
final  class MainExcerciseActivity_imageView_Click implements OnClickListener {
    private final MainExcerciseActivity arg$1;

    MainExcerciseActivity_imageView_Click(MainExcerciseActivity mainExcerciseActivity) {
